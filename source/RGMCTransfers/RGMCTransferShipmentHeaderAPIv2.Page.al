page 50329 "RGMC Tfr Shipment Hdr API v2"
{
    PageType = API;
    APIPublisher = 'rgmc';
    APIGroup = 'rgmccustom';
    APIVersion = 'v2.0';
    EntityName = 'transferShipmentHeader';
    EntitySetName = 'transferShipmentHeaders';
    Caption = 'RGMC Tfr Shipment Hdr API v2';
    ...
    layout
    {
        area(Content)
        {
            ...
            part(transferShipmentLines; "RGMC Tfr Shipment Line API v2")
            {
                Caption = 'transferShipmentLines';
